...
$ouDN = "OU=[placeholder],DC=[placeholder],DC=com"
...
$outputFileBase = "[placeholder]_$dateString.csv" #change this then map this path to your own drive and keep _$dateString.csv
...
while (Test-Path $outputFile) {
    $outputFile = "[placeholder]_$dateString($counter).csv"
    $counter++
}
